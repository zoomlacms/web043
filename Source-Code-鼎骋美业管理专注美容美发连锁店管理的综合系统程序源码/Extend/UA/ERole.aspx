<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ERole.aspx.cs" Inherits="Extend_UA_ERole" MasterPageFile="~/Common/Master/User.Master" %>
...
<ZL:Top_StoreConfig runat="server" ID="Top_StoreConfig" />
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
         ...
         <li class="breadcrumb-item">
            <a href="<%=Request.RawUrl %>">员工角色</a>
             [<a href="ERoleAdd.aspx">添加角色</a>]
        </li>
    </ol>
<ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="False" PageSize="10" IsHoldState="false" 
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="名称">
            <ItemTemplate><a href="ERoleAdd.aspx?ID=<%#Eval("ID") %>"><%#Eval("RoleName") %></a></ItemTemplate>
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="操作" ItemStyle-CssClass="td_l">
            <ItemTemplate>
                <a class="option_style" href="ERoleAdd.aspx?id=<%#Eval("ID") %>"><i class="fa fa-pencil" title="修改"></i></a>
