<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddMsgTlp.aspx.cs" Inherits="ZoomLaCMS.Manage.WeiXin.Msg.AddMsgTlp" MasterPageFile="~/Common/Master/User.Master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
 <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="<%=Request.RawUrl %>">图文消息</a></li>
</ol>
