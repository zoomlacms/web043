<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddReply.aspx.cs" Inherits="Extend_WX_AddReply" MasterPageFile="~/Common/Master/User.Master"%>
...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="<%=Request.RawUrl %>">回复管理</a></li>
</ol>
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            <td></td><td >
                ...
                <a href="AutoReply.aspx" class="btn btn-primary">返回列表</a></td>
        </tr>
    </table>
</asp:Content>
